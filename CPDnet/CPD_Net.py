# https://github.com/wuzhe71/CPD/blob/master/model/CPD_ResNet_models.py
...
class RFB(nn.Module):
    ...
    def __init__(self, in_channel, out_channel):
        ...
        self.branch1 = nn.Sequential(
            BasicConv2d(in_channel, out_channel, 1),
            # kernel_size表示height = 1，width = 3  padding上下填充0，左右两边各填充1个
    ...
    def forward(self, x):
        ...
        x2 = self.branch2(x)
        x3 = self.branch3(x)
        # torch.cat((x0, x1, x2, x3), 1)在第1个维度（channel）上拼接
